...
glm_model <- glm(diagnosis ~ radius_mean + concave.points_mean, data = data, family = "binomial")

# Previste probabilità della variabile dipendente
predicted_probabilities <- predict(glm_model, data, type = 'response')

# Converti le probabilità previste in True/False
predicted_diagnosis <- ifelse(predicted_probabilities >= 0.5, "True", "False")

# Calcola l'accuratezza del modello
accuracy <- mean(predicted_diagnosis == data$diagnosis)
print(paste("Accuratezza del modello:", round(accuracy, 4)))
